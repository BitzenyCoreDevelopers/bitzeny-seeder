...
static const string mainnet_seeds[] = {"bitzeny-node-1.web4u.jp",
				       "bitzeny-node-2.web4u.jp",
				       ""};
static const string testnet_seeds[] = {"bitzeny-node-1.web4u.jp",
				       "bitzeny-node-2.web4u.jp",
				       ""};
...
extern "C" void* ThreadSeeder(void*) {
  //if (!fTestNet){
  //  db.Add(CService("xxxxxxxxxxxxxxxx.onion", 9253), true);
  //}
  do {
